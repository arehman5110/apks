                            ...
                            <fieldset class="form-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card p-4">
                                            <div class="row">
                                                <div class="col-md-6"><label for="s19_064">{{ __('messages.PVC_Span') }}
                                                        19/064</label></div>
                                                <div class="col-md-6"><input type="number" name="pvc_span[s19_064]"
                                                        disabled id="s19_064"
                                                        value="{{ getInputValue('s19_064', $data->pvc_span) }}"
                                                        class="form-control"></div>
                                            </div>


                                            <div class="row">
                                                <div class="col-md-6"><label for="s7_083">{{ __('messages.PVC_Span') }}
                                                        7/083</label></div>
                                                <div class="col-md-6"><input type="number" name="pvc_span[s7_083]"
                                                        disabled id="s7_083"
                                                        value="{{ getInputValue('s7_083', $data->pvc_span) }}"
                                                        class="form-control"></div>
                                            </div>

                                            <div class="row">
                                                <div class="col-md-6"><label for="s7_044">{{ __('messages.PVC_Span') }}
                                                        7/044</label></div>
                                                <div class="col-md-6"><input type="number" name="pvc_span[s7_044]"
                                                        disabled id="s7_044"
                                                        value="{{ getInputValue('s7_044', $data->pvc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card p-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><input type="number" name="bare_span[s7_173]"
                                                        disabled id="s7_173"
                                                        value="{{ getInputValue('s7_173', $data->pvc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><input type="number" name="bare_span[s7_122]"
                                                        disabled id="s7_122"
                                                        value="{{ getInputValue('s7_122', $data->pvc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6"><label
                                                ...
                                                <div class="col-md-6"><input type="number" name="bare_span[s3_132]"
                                                        disabled id="s3_132"
                                                        value="{{ getInputValue('s3_132', $data->pvc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card p-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><input type="number" name="abc_span[s3_185]"
                                                        disabled id="section_to"
                                                        value="{{ getInputValue('s3_185', $data->abc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><input type="number" name="abc_span[s3_95]"
                                                        disabled id="s3_95"
                                                        value="{{ getInputValue('s3_95', $data->abc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><input type="number" name="abc_span[s3_16]"
                                                        disabled id="s3_16"
                                                        value="{{ getInputValue('s3_16', $data->abc_span) }}"
                                                        class="form-control"></div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><input type="number" name="abc_span[s1_16]"
                                                        id="s1_16"
                                                        value="{{ getInputValue('s1_16', $data->abc_span) }}" disabled
                                                        class="form-control"></div>
                                            </div>
