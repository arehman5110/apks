                                ...
                                <div class="card p-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input type="number" name="bare_span[s7_173]" disabled
                                                id="s7_173" value="{{  getInputValue('s7_173' ,$data->pvc_span) }}"
                                                class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input type="number" name="bare_span[s7_122]" disabled
                                                id="s7_122" value="{{  getInputValue('s7_122' ,$data->pvc_span)  }}"
                                                class="form-control"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input type="number" name="bare_span[s3_132]" disabled
                                                id="s3_132" value="{{ getInputValue('s3_132' ,$data->pvc_span)  }}"
                                                class="form-control"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card p-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input type="number" name="abc_span[s1_16]"
                                                id="s1_16" value="{{  getInputValue('s1_16' ,$data->abc_span)}}" disabled
                                                class="form-control"></div>
                                    </div>
