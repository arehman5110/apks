                            ...
                            <fieldset class="form-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card p-4">
                                            <div class="row">
                                                <div class="col-md-4"><label for="s19_064">{{ __('messages.PVC_Span') }}
                                                        19/064</label></div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><label for="s7_083">{{ __('messages.PVC_Span') }}
                                                        7/083</label></div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><label for="s7_044">{{ __('messages.PVC_Span') }}
                                                        7/044</label></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card p-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><label for="s3_95">{{ __('messages.ABC_Span') }}
                                                        3 X 95</label></div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><label for="s3_16">{{ __('messages.ABC_Span') }}
                                                        3 X 16</label></div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><label for="s1_16">{{ __('messages.ABC_Span') }}
                                                        1 X 16</label></div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th rowspan="2">{{ __('messages.signage_off_point_two_way_supply') }}
                                                </th>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" name="kawasan[other_input]"
                                                        value="{{ checkCheckBox('other_input', $data->kawasan) != 'checked' ? '' : $data->kawasan['other_input'] }}"
                                                        id="area_other-input"
