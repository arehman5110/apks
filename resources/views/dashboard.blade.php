                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span id="total_km">{{ $data->total_km }} KM</span>
                                    </p>
                            ...
                            <div class="col-md-4">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span
                                            id="total_notice">{{ $data->total_notice ?? '0' }}</span></p>
                            ...
                            <div class="col-md-4">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span
                                            id="total_supervision">{{ $data->total_supervision ?? 0 }}</span></p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span id="substation">{{ $data->substation }}</span>
                                    </p>
                            ...
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span
                                            id="substation_defects">{{ $data->substation_defects }}</span></p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span
                                            id="feeder_pillar">{{ $data->feeder_pillar }}</span></p>
                            ...
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span id="fp_defects">{{ $data->fp_defects }}</span>
                                    </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span id="link_box">{{ $data->link_box }}</span>
                                    </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span
                                            id="cable_bridge">{{ $data->cable_bridge }}</span></p>
                            ...
                            <div class="col-md-6">
                                <div class="card p-3">
                                    ...
                                    <p class="text-center mb-0 pb-0"><span
                                            id="cablebridge">{{ $data->cablebridge }}</span></p>
