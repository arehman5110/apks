                    ...
                    <div class="form-input ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if ($data->visit_date != '' && $data->link_box_image_1 != '')
                                ...
                                <div class="dropdown-menu" role="menu">
                                    @if ($data->qa_status != 'Accept')
                                        <a href="/{{ app()->getLocale() }}/link-box-pelbagai-voltan-update-QA-Status?status=Accept&&id={{ $data->id }}"
...
<script>
    $(function(){
        $('#rejectReasonModal').on('show.bs.modal', function(event) {
            ...
            $('#reject-foam').attr('action', `/{{app()->getLocale()}}/link-box-pelbagai-voltan-update-QA-Status`)
            $('#reject-id').val(id);
        });
    })
</script>
