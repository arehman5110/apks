...
<div class="side-bar" style="height: 569px !important; overflow-y: scroll;">
                    ...
                    <details class="mb-3">
                       ...
                       <ul >
                        <li > <input  type="checkbox" name="" id="petroling_a" onclick="addpanolayer()"> <label for="petroling_a" >Pemeriksaan di Jalan</label> </li>
                      ...
                      <details class="mb-3">
                       ...
                       <ul >
                        ...
                        <li><input type="checkbox" name="" id="tiang_d"> <label for="tiang_d">Pemeriksaan kebocoran arus pada tiang</label></li>
                        <li ><input type="checkbox" name="" id="tiang_e"> <label for="tiang_e">Report</label> </li>
                         </ul>
                      </details>
        ...
        $.ajax({
            ...
            success: function callback(data) {
                ...
                pannellum.viewer('panorama', {
                    ...
                    "panorama": "http://121.121.232.54:88/"+data.features[0].properties.photo,
                    "compass": true,
                    "autoLoad": true
                });
